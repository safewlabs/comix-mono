...
class Dashboard::ProductsController < Dashboard::BaseController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :user_id, :issue_cover, :file_attachment, :description, :age_rating, :page_count, :price, :release_date, :store_id, :video_url, :disable_download, creator_profile_ids: [], genre_ids: [])
    end
